...
<?php $__env->startSection('title', 'Login Admin Photobooth'); ?>
...
<div class="max-w-md mx-auto px-4 py-16">
    <div class="bg-slate-900 border border-slate-800 rounded-3xl p-8 shadow-2xl">
        ...
        <div class="mt-6 pt-4 border-t border-slate-800 text-center">
            <a href="<?php echo e(route('photobooth.index')); ?>" class="text-xs text-slate-400 hover:text-white flex items-center justify-center gap-1.5">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\xampp\htdocs\photobooth\resources\views\admin\login.blade.php ENDPATH**/ ?>