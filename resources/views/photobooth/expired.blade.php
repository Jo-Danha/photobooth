...
@section('title', 'Sesi Berakhir - Photobooth')
...
<div class="max-w-md mx-auto px-4 py-16 text-center">
    <div class="bg-slate-900 border border-slate-800 rounded-3xl p-8 shadow-2xl">
        ...
        <p class="text-xs text-slate-400 mt-2 mb-6">
            Batas waktu sesi foto Anda ({{ $session->duration_minutes }} menit) telah selesai.
        </p>

        <a href="{{ route('photobooth.index') }}" class="w-full py-3 px-6 rounded-xl bg-brand-600 hover:bg-brand-500 text-white font-bold text-xs block">
            Mulai Sesi Baru
        </a>
    </div>
</div>
