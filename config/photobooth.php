...
return [
    ...
    */
    'packages' => [
        ...
        [
            'id'          => 'ar',
            'name'        => 'AR Filter Layout',
            'description' => 'Strip 4 foto — pilih filter AR favoritmu di studio (anjing, kucing, kelinci, rubah, hati, kacamata)',
            'shots'       => 4,
            'duration'    => 5,
            'price'       => 18000,
            'popular'     => false,
    ...
    */
    'frame_sizes' => [
        ...
        'ar'        => ['w' => 400, 'h' => 1164, 'label' => 'Strip 1 kolom (4 foto)'],
        'hearts'    => ['w' => 400, 'h' => 1164, 'label' => 'Strip 1 kolom (4 foto)'],
        'dog'       => ['w' => 400, 'h' => 1164, 'label' => 'Strip 1 kolom (4 foto)'],
        'cat'       => ['w' => 400, 'h' => 1164, 'label' => 'Strip 1 kolom (4 foto)'],
        'bunny'     => ['w' => 400, 'h' => 1164, 'label' => 'Strip 1 kolom (4 foto)'],
        'fox'       => ['w' => 400, 'h' => 1164, 'label' => 'Strip 1 kolom (4 foto)'],
        'cool'      => ['w' => 400, 'h' => 1164, 'label' => 'Strip 1 kolom (4 foto)'],
    ],
